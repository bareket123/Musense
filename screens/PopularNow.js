...
const PopularNow = () => {
    ...
    // const playedRecently = useSelector((state) => state.cardData);
...
//     const [sound, setSound] = useState();
//     const [songsArray, setSongsArray] = useState([]);
//     const [isInMyPlaylist, setIsInMyPlaylist] = useState(false);
//
//     async function playSound(index) {
//         const song = songsArray[index];
//         dispatch(setPlayedRecently(song));
...
//         const song = songsArray[index];
//         const updatedSongsArray = songsArray.filter((_, i) => i !== index);
//         setSongsArray(updatedSongsArray);
//     }
//
...
//         }
//         setIsInMyPlaylist(!isInMyPlaylist);
//     }
//
//     const renderSong = ({ item }) => (
//         <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10 }}>
...
//                 <AntDesign onPress={() => pauseSound(item.songIndex).then(r => {})} name={"pausecircle"} size={30} color="black" />
//                 <AntDesign onPress={() => playSound(item.songIndex).then(r => {})} name="play" size={30} color="black" />
//                 <TouchableOpacity onPress={() => handleToggleFavorite(item.songIndex)}>
//                     <AntDesign name="heart" size={30} color={isInMyPlaylist ? 'red' : 'green'} />
//                 </TouchableOpacity>
//             </TouchableOpacity>
//         </View>
//     );
